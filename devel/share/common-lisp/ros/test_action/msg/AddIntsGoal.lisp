...
(cl:defmethod cl:initialize-instance :after ((m <AddIntsGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddIntsGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test_action-msg:<AddIntsGoal> is deprecated: use test_action-msg:AddIntsGoal instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <AddIntsGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_action-msg:num-val is deprecated.  Use test_action-msg:num instead.")
  (num m))
