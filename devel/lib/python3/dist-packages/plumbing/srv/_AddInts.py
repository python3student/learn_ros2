...
"""autogenerated by genpy from plumbing/AddIntsRequest.msg. Do not edit."""
import codecs
import sys
...
def _get_struct_2i():
    ...
    return _struct_2i
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from plumbing/AddIntsResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class AddIntsResponse(genpy.Message):
  ...
  _type = "plumbing/AddIntsResponse"
  _has_header = False  # flag to mark the presence of a Header object
